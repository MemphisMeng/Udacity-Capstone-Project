...
spark = SparkSession \
    ...
    .getOrCreate()
# read from local
movies = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/movies").toPandas()
movies.drop_duplicates(inplace=True)
df_predict = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/df_predict").toPandas()
ratings = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/rating").toPandas()
user_profile = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/user_profile").toPandas()
TFIDF = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/TFIDF").toPandas().set_index('movieId')
movie_profile = spark.read.parquet("s3://aws-emr-resources-699444535296-us-east-1/data lake/movie_profile").toPandas()
